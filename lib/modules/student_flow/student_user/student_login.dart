...
class StudentLogin extends StatelessWidget {
  ...
  StudentLoginController _studentLoginController = Get.put(StudentLoginController());
    ...
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
          child: Center(
            child: Form(
              key: _studentLoginController.studentloginKey,
              child: Column(
                children: [
                  SizedBox(height: 2.h,),
                  ...
                  SizedBox(
                    width: 85.w,
                    child: TextFormField(
                        controller: _studentLoginController.mobile,
                  ...
                  SizedBox(
                    width: 85.w,
                    child: TextFormField(
                        controller: _studentLoginController.password,
